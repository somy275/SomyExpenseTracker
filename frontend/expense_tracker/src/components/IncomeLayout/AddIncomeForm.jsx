...
import { AddIncome, GetIncome } from '../../Store/incomeSlice';
import { useDispatch, useSelector } from "react-redux"
const AddIncomeForm = ({ showAddIncomeForm, setshowAddIncomeForm }) => {
        ...
        showAddIncomeForm && (
            <div className='fixed inset-0 bg-[rgba(0,0,0,0.5)] flex items-center justify-center z-50 '>
                <div className='bg-white p-6 rounded-xl shadow-2xl w-full max-w-md overflow-y-auto max-h-[95%]'>
                    ...
                    <form onSubmit={handleSubmit(onIncome)} className='mt-6 flex flex-col justify-around gap-4'>
                        {
